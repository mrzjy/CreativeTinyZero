...
class GRPOScriptArguments(ScriptArguments):
    ...
    reward_funcs: list[str] = field(
        default_factory=lambda: ["diversity_reward_func", "format", "answer_quality", "think_quality"],
        metadata={
...
def main(script_args, training_args, model_args):
    ...
    REWARD_FUNCS_REGISTRY = {
        ...
        "answer_quality": answer_quality_reward_func,
        "think_quality": think_quality_reward_func,
    }
